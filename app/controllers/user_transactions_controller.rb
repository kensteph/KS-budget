class UserTransactionsController < ApplicationController
  ...
  def index
    ...
    @transactions = UserTransaction.includes(:author, :category)
      .where(author_id: current_user, category_id: params[:category_id].to_i)
  ...
  def create
    ...
    respond_to do |format|
      if @transaction.save
        format.html do
          redirect_to category_user_transactions_path(params[:category]),
